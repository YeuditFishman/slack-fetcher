...
class TestSlackUsers(unittest.TestCase):
    ...
    def test_get_slack_users(self, mock_get):
        ...
        mock_get.return_value.json.return_value = {
            "ok": True,
            "members": [
                {"id": "U123", "name": "rikif", "real_name": "Riki F", "is_bot": False},
                {"id": "U124", "name": "yehuditfi", "real_name": "Yehudit F", "is_bot": False}
            ]
        }
    ...
    def test_save_users_to_json(self):
        users = [
            {"id": "U123", "username": "rikif", "full_name": "Riki F", "is_bot": False}
        ]
